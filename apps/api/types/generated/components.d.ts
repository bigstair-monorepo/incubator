...
export interface SectionsCommunication extends Schema.Component {
  collectionName: 'components_sections_communications';
  info: {
  ...
  attributes: {
    ...
    description: Attribute.Component<'elements.slider-card'>;
    SliderCard: Attribute.Component<'elements.slider-card', true>;
  };
}
...
export interface ElementsSliderCard extends Schema.Component {
  collectionName: 'components_elements_slider_cards';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'sections.communication': SectionsCommunication;
      ...
      'elements.slider-card': ElementsSliderCard;
